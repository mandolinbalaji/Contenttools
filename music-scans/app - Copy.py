...
_write_lock = False  # simple single process guard
...
def _normalise_song(s):
    ...
    # lyrics: accept alternate keys or list, always produce a string
...
def _load_songs():
    ...
    _save_songs(data, make_backup=False)  # persist ids or field normalisation
    return data
...
@app.get("/favicon.ico")
def favicon():
    # tiny inline orange circle to avoid 404 noise
